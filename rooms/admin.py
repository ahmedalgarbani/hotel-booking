...
class AvailabilityAdmin(HotelManagerAdminMixin, admin.ModelAdmin):
    ...
    list_display = ['room_type', 'hotel', 'date', 'available_rooms', 'price', 'room_status', 'bulk_create_button']
    search_fields = ['room_type__name', 'hotel__name']
    list_filter = ['hotel', 'date', 'room_type', 'room_status']
    list_editable = ['available_rooms', 'price']
    date_hierarchy = 'date'
