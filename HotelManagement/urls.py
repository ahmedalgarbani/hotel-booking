...
urlpatterns = [
    ...
    # مسارات طلبات الفنادق
    path('requests/<int:request_id>/detail/', views.hotel_request_detail, name='hotel_request_detail'),
    path('requests/<int:request_id>/approve/', views.approve_hotel_request, name='approve_hotel_request'),
