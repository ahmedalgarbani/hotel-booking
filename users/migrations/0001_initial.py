    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'مدير النظام'), ('hotel_manager', 'مدير فندق'), ('customer', 'عميل'), ('hotel_staff', 'موظف')], help_text='نوع حساب المستخدم في النظام', max_length=20, verbose_name='نوع المستخدم')),
                ...
                ('chield', models.ForeignKey(blank=True, help_text='الموظف المعين من قبل مدير الفندق', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employees', to=settings.AUTH_USER_MODEL, verbose_name='الموظف المعين')),
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_approve_request', 'Can approve hotel account request'), ('can_reject_request', 'Can reject hotel account request')],
            },
        ),
        migrations.CreateModel(
            name='ActivityLog',
